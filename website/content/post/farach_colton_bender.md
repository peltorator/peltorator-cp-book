...
Ознакомиться с алгоритмом можно в [соответствующей статье](/try_web/post/rmq_offline/).
...
- Также можете прорешать специально подготовленный [контест](https://codeforces.com/group/1rv4rhCsHp/contest/325878) на codeforces на эту тему.   
